...
int matrix_multiply(struct matrix *c, struct matrix *d, const struct matrix *a, const struct matrix *b)
{
	/* A is m * n x n * p = m * p */
...
int main(int argc, char *argv[])
{
	...
	matrix_init(&d, b.n_cols, b.n_rows);

	matrix_multiply(&c, &d, &a, &b);
